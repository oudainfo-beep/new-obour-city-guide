...
function archivePage(chrome, q3) {
  ...
  const comparisonRows = (q3?.comparisons?.length ? q3.comparisons : [
    ...
    { city: "العبور القائمة", average: "16,000–22,000 ج.م", note: "خدمات ناضجة، سكن فوري · متوسط العروض المعلنة ≈21,500 ج.م (مصادر عالمية، ديسمبر 2025)" },
  ])
  ...
  const trendsPara = q3?.trends
    ? `<p>${q3.trends}</p>`
    : `<p>شهدت العبور القائمة نموًا سنويًا قويًا في أسعار العروض المعلنة (+39.9% للشقق و+109% للفيلات خلال 12 شهرًا حتى يناير 2026 وفق Realting)، بينما شهد الربع الثالث من 2026 استقرارًا نسبيًا في أسعار العبور الجديدة مع زيادة طفيفة في الأحياء القريبة من محطات LRT.</p>`;

  const pressSummary = `
<h2>ملخص صحفي</h2>
<p>وفقًا لتقرير الربع الثالث 2026 المنشور في دليل العبور، يتراوح متوسط سعر المتر للشقة في العبور الجديدة بين 7,500 و12,000 ج.م، وتقع الشقق الصغيرة (70–90 م²) في نطاق 550,000–950,000 ج.م، والشقق المتوسطة (100–130 م²) بين 850,000–1,400,000 ج.م، والشقق الكبيرة (140–180 م²) بين 1,200,000–2,000,000 ج.م، فيما تبدأ الفيلات (200–350 م²) من 2,500,000 ج.م وتصل إلى 5,000,000 ج.م، والوحدات التجارية (محلات) بين 12,000 و25,000 ج.م/م².</p>
<p>المقارنة مع المدن المجاورة تُظهر أن متوسط المتر في العبور الجديدة أقل من التجمع الخامس (15,000–28,000 ج.م) والعاصمة الإدارية (18,000–35,000 ج.م) والعبور القائمة (16,000–22,000 ج.م بمتوسط عروض معلنة ≈21,500 ج.م وفق Global Property Guide وRealting، ديسمبر 2025–يناير 2026)، بينما يقترب من الطرف الأدنى لنطاق الشروق (9,000–14,000 ج.م)، مما يجعلها خيارًا سكنيًا أقل تكلفة نسبيًا لمن يقبل فترة بناء الخدمات.</p>
<p>الاتجاه المسجل في الربع الثالث من 2026 هو استقرار نسبي في الأسعار مع زيادة طفيفة في الأحياء القريبة من محطات LRT، بينما تقدم الأحياء الجديدة (الحي 24 والحي 25) فرص شراء بأسعار أقل مقابل انتظار اكتمال الخدمات؛ كما تشير البيانات إلى أن الوحدات المتشطبة أغلى من غير المتشطبة بنسبة 20–40%.</p>
`;
