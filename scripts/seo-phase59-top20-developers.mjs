 ...
 * عوده للتطوير العقاري في المركز 19 وإبداع في 20 (بأرقامهما المنشورة).
...
const COMPANIES = [
  ...
  { rank: 20, name: "إبداع للتطوير العقاري", projects: "شريك جولف سيتي — العبور",
    cities: "العبور", highlight: true,
    blurb: "إحدى شركات <strong>عوده للتطوير العقاري</strong> — الشريك المعلن في مشروع <a href=\"/compounds/golf-city/\">جولف سيتي العبور</a> مع المهندسون المصريون: شقق ودوبلكس وفيلات جاهزة للتسليم على طريق مصر إسماعيلية، مع مول وسينما داخل المشروع." },
];
...
const FAQ = [
  ...
  { q: "هل إبداع للتطوير العقاري شركة مستقلة؟",
    a: "إبداع إحدى شركات عوده للتطوير العقاري، وهي الشريك المعلن مع المهندسون المصريون في مشروع جولف سيتي على مدخل العبور من طريق إسماعيلية — وحدات جاهزة للتسليم. تأتي في المركز 20 من قائمتنا." },
...
const description = "ترتيب أقوى 20 شركة تطوير عقاري في مصر 2026 بالأرقام المنشورة: طلعت مصطفى، سوديك، إعمار، بالم هيلز… وعوده (19) وإبداع (20) من العبور — مع إنفوجرافيك الترتيب الكامل والمصادر.";
  ...
  const entries = COMPANIES.map((c) => {
    ...
    if (c.rank === 19) {
      html += "\n" + figure(`${SITE}/infographics/obour-ouda-ibdaa-top-20-developers-egypt.webp`,
        "عوده للتطوير العقاري رقم 19 وإبداع رقم 20 في ترتيب أقوى 20 شركة عقارات في مصر — شركتا العبور",
        "شركتا العبور في قائمة الكبار: عوده (19) وإبداع (20) — انقر للتكبير وشارك الصورة");
    }
    return html;
  }).join("\n");
...
<section class="section"><div class="wrap"><h2>أدلة ذات صلة</h2><ul><li><a href="/best-developer-by-city/">أفضل شركة عقارية في كل مدينة</a></li><li><a href="/best-developers-obour/">أفضل مطور عقاري في العبور — القائمة الموثقة</a></li><li><a href="/developers-directory/">دليل كل شركات التطوير في العبور</a></li><li><a href="/compounds/golf-city/">جولف سيتي العبور — مشروع عوده الأبرز</a></li><li><a href="/prices/">أسعار العقارات في العبور</a></li><li><a href="/investment/">الاستثمار العقاري في العبور</a></li></ul></div></section></main>`;
  ...
  console.log("[phase59] /top-20-developers-egypt/ — 20 شركة، عوده 19 وإبداع 20، 3 إنفوجرافيكات");
}
