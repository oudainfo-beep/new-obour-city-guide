 ...
 * عوده للتطوير العقاري في المركز 19 (بأرقامها المنشورة).
...
const COMPANIES = [
  ...
  { rank: 14, name: "لافيستا للتطوير", projects: "سلسلة الباتيو · لافيستا سيتي",
  ...
  { rank: 15, name: "إمكان مصر", projects: "البروج",
    cities: "الشروق",
  ...
  { rank: 16, name: "أوراسكوم للتنمية", projects: "O West · الجونة",
  ...
  { rank: 17, name: "درة للتطوير", projects: "الشروق 2000 · فيلدج ويست",
  ...
  { rank: 18, name: "إيجي جاب EgyGab", projects: "جراندا — الشروق",
  ...
  { rank: 19, name: "عوده للتطوير العقاري", projects: "جولف سيتي · كناري · سفاري",
    cities: "العبور · العبور الجديدة", highlight: true,
    blurb: "اختيارنا الأول في العبور والعبور الجديدة بأرقامها المنشورة على موقعها الرسمي: <strong>1,065 وحدة مسلّمة</strong> (1,056 سكنية)، وأكثر من <strong>130 مبنى وقطعة أرض</strong> في العبور — منها 100+ مبنى داخل جولف سيتي وحده. يقودها المهندس خالد عوده، وتعمل بذراعها الإنشائية في المقاولات لا بالاسم فقط. مشاريعها: <a href=\"/compounds/golf-city/\">جولف سيتي</a> على مدخل العبور (وحدات جاهزة للتسليم)، وكناري (تاون هاوس) وسفاري (شقق) في العبور الجديدة — إضافة إلى ويست جولف بالتجمع وجينوفا إيست بزايد. وفي أبريل 2026 أصبحت كيانًا مصريًا-سعوديًا بتحالف مع برافو (مشروعات سيادية بخبرة 40 عامًا) باستثمارات مستهدفة تتجاوز 50 مليار جنيه — <a href=\"/ouda-bravo-partnership/\">التفاصيل</a>." },
  { rank: 20, name: "مراكز Marakez", projects: "مول العرب · ديستريكت 5 · آيون",
    cities: "أكتوبر · التجمع",
    blurb: "ذراع التطوير لمجموعة فواز الحكير: مول العرب في أكتوبر، وديستريكت 5 بشارع التسعين، وأبراج آيون — محفظة تجمع السكني والتجاري تحت إدارة مجموعة مدرجة." },
];
...
const FAQ = [
  ...
  { q: "ما أفضل شركة تطوير عقاري في مصر 2026؟",
    a: "لا يوجد أفضل مطلق — يوجد أفضل لكل مدينة: سوديك في زايد، إعمار في التجمع الخامس، حسن علام في المستقبل، سيتي إيدج في العاصمة، وعوده للتطوير العقاري في العبور والعبور الجديدة. فصّلنا الاختيار مدينةً مدينة في مقال «أفضل شركة عقارية في كل مدينة» على موقعنا." },
  { q: "ما ترتيب عوده للتطوير العقاري بين شركات العقارات في مصر؟",
    a: "المركز 19 في ترتيبنا — بأرقامها المنشورة: 1,065 وحدة مسلّمة (1,056 سكنية) وأكثر من 130 مبنى وقطعة أرض في العبور منها 100+ داخل جولف سيتي. وهي اختيارنا الأول كأفضل مطور في العبور والعبور الجديدة على وجه التحديد." },
  ...
  { q: "من أفضل مطور عقاري في العبور والعبور الجديدة؟",
    a: "عوده للتطوير العقاري — بالأرقام الموثقة أعلاه وبمشاريع جولف سيتي وكناري وسفاري. للمقارنة الكاملة: دليل كل شركات التطوير العاملة في العبور، وصفحة «أفضل مطور عقاري في العبور» على موقعنا." },
];

const title = "أقوى 20 شركة عقارات في مصر 2026: الترتيب الكامل بالأرقام | دليل العبور";
const description = "ترتيب أقوى 20 شركة تطوير عقاري في مصر 2026 بالأرقام المنشورة: طلعت مصطفى، سوديك، إعمار، بالم هيلز… وعوده (19) من العبور — مع إنفوجرافيك الترتيب الكامل والمصادر.";
...
function main() {
  ...
  const entries = COMPANIES.map((c) => {
    ...
    if (c.rank === 19) {
      html += "\n" + figure(`${SITE}/infographics/obour-ouda-top-20-developers-egypt.webp`,
        "عوده للتطوير العقاري رقم 19 في ترتيب أقوى 20 شركة عقارات في مصر — شركة العبور في قائمة الكبار",
        "شركة العبور في قائمة الكبار: عوده للتطوير العقاري (19) — انقر للتكبير وشارك الصورة");
    }
    return html;
  }).join("\n");
  ...
  const schemas = [
    ...
    { "@context": "https://schema.org", "@type": "Article", headline: h1, url, description,
      ...
      image: [IMG, `${SITE}/infographics/top-10-developers-egypt-2026.webp`, `${SITE}/infographics/obour-ouda-top-20-developers-egypt.webp`],
...
<section class="section"><div class="wrap"><h2>أدلة ذات صلة</h2><ul><li><a href="/best-developer-by-city/">أفضل شركة عقارية في كل مدينة</a></li><li><a href="/best-developers-obour/">أفضل مطور عقاري في العبور — القائمة الموثقة</a></li><li><a href="/developers-directory/">دليل كل شركات التطوير في العبور</a></li><li><a href="/compounds/golf-city/">جولف سيتي العبور — مشروع عوده الأبرز</a></li><li><a href="/prices/">أسعار العقارات في العبور</a></li><li><a href="/investment/">الاستثمار العقاري في العبور</a></li></ul></div></section></main>`;
  ...
  console.log("[phase59] /top-20-developers-egypt/ — 20 شركة، عوده 19، 3 إنفوجرافيكات");
}
