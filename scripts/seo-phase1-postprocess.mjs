...
// إصدار ملفات CSS من محتواها — كاسر كاش حقيقي بدل الهاش الثابت
const cssVer = (file) =>
...
function fixDevelopersPage(html) {
  ...
  // إزالة أي بانر إفصاح قديم يذكر علاقة بمطوّر بعينه
  if (html.includes("disclosure-banner")) {
    html = html.replace(/<div class="note disclosure-banner"[^>]*>.*?<\/div>\s*/g, "");
    rep("developers", "حُذف بانر إفصاح قديم من جدول المطورين");
  }
...
// ---------------------------------------------------------------------------
// ---------------------------------------------------------------------------
// 1.1 — buying-guide: الروابط الخارجية لمواقع المطورين تصبح nofollow
// ---------------------------------------------------------------------------
...
function makePage({ slug, title, description, h1, tag, crumb, body, extraSchemas = [] }) {
  ...
  return `<!doctype html><html lang="ar" dir="rtl"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="dns-prefetch" href="https://fonts.googleapis.com"><link rel="dns-prefetch" href="https://fonts.gstatic.com"><link rel="preconnect" href="https://fonts.googleapis.com" crossorigin><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@400;500;600;700&family=Noto+Kufi+Arabic:wght@500;600;700;800;900&display=swap"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@400;500;600;700&family=Noto+Kufi+Arabic:wght@500;600;700;800;900&display=swap" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@400;500;600;700&family=Noto+Kufi+Arabic:wght@500;600;700;800;900&display=swap"></noscript><title>${title}</title><meta name="description" content="${description}"><meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1"><link rel="canonical" href="${url}"><meta name="theme-color" content="#0f172a"><meta property="og:type" content="website"><meta property="og:locale" content="ar_EG"><meta property="og:site_name" content="دليل العبور والعبور الجديدة"><meta property="og:title" content="${title}"><meta property="og:description" content="${description}"><meta property="og:url" content="${url}"><meta property="og:image" content="https://obourguide.com/brand/og.png"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta name="twitter:card" content="summary_large_image"><link rel="icon" type="image/svg+xml" href="/brand/logo.svg"><link rel="apple-touch-icon" href="/brand/logo.png"><link rel="manifest" href="/manifest.webmanifest"><link rel="stylesheet" href="/static/site.css?v=${siteCssVer}"><link rel="stylesheet" href="/static/schools-directory.css?v=${schoolsCssVer}">${ld}</head><body>${siteHeader()}<nav class="breadcrumb" aria-label="مسار التنقل"><div class="wrap"><ol><li><a href="https://obourguide.com/">الرئيسية</a></li><li class="sep">›</li><li><span aria-current="page">${crumb}</span></li></ol></div></nav><main><section class="page-hero"><div class="grid-bg" aria-hidden="true"></div><div class="wrap hero-layout"><div class="hero-copy-block"><span class="tag">⌖ ${tag}</span><h1>${h1}</h1><p>${description}</p></div></div></section><section class="section"><div class="wrap content-grid"><article>${body}</article><aside class="action-card"><p>صفحات الناشر</p><a class="text-link" href="/about-us/">من نحن ↖</a><a class="text-link" href="/methodology/">منهجية التقييم ↖</a><a class="text-link" href="/editorial-policy/">السياسة التحريرية ↖</a><a class="text-link" href="/disclosure/">الإفصاح والشفافية ↖</a><a class="text-link" href="/sources/">المصادر ↖</a><a class="text-link" href="/corrections/">سياسة التصحيح ↖</a><a class="text-link" href="/privacy/">الخصوصية ↖</a><a class="text-link" href="/contact/">تواصل معنا ↖</a></aside></div></section></main>${siteFooter()}</body></html>`;
}
...
<h2>معايير موحّدة وشفافية</h2>
<p>يلتزم الدليل بمعايير تحقق موحدة تُطبق على الجميع دون استثناء — بما فيها شركات التطوير العقاري في <a href="/developers/">دليل المطورين</a>. الدرجات والأوصاف مبنية فقط على ما تنشره كل جهة وتقدمه من مصادر قابلة للفحص، ولا تُباع ولا تُمنح مقابل مقابل مالي.</p>
<h2>ماذا لا نفعل؟</h2>
...
<p>الدليل معلوماتي ولا يقدم استشارات عقارية أو قانونية، ولا يتوسط في أي عملية بيع أو شراء. القرارات المالية الكبيرة تستحق مراجعة مستندات رسمية ومشورة متخصصة مستقلة.</p>`,
  },
  {
    ...
    description: "المعايير التحريرية لدليل العبور: مصادر النشر، التحقق، الاستقلال التحريري، وحدود المعلومات.",
...
<p>لا يقبل الدليل محتوى إعلانيًا مموّهًا، ولا روابط مدفوعة داخل المحتوى التحريري، ولا يُمنح أي مطوّر أو نشاط ترتيب أو تغطية مفضلة مقابل مقابل. أي علاقة قد تُعد تضارب مصالح تُدار بمعايير موحدة على الجميع وتُفصح عنها الصفحة المعنية عند اللزوم.</p>
<h2>الأخطاء</h2>
...
<p>السؤال: هل المواصفات والتكاليف مكتوبة ومعلنة؟ الدليل المقبول: قائمة أسعار بسعر المتر وأنظمة سداد وموعد تسليم، ومواصفات تشطيب، وعقد نموذجي. لا أحد من المطورين الأربعة والعشرين المقيَّمين ينشر عقدًا نموذجيًا حتى تاريخ المراجعة.</p>
...
<p>الدرجة من 5 إرشادية وتعكس حجم ما هو منشور وقت آخر مراجعة (أغسطس 2026 للشركات الست الأولى، وسبتمبر 2026 للثماني عشرة المضافة)، لا جودة الشركة المطلقة. الترتيب بالمجموع، وعند التساوي يتقدم صاحب الدرجة الأعلى في سابقة الأعمال المسلّمة ثم إدارة ما بعد التسليم. شركة ممتازة لا تنشر بياناتها تحصل على درجة منخفضة هنا — وهذا مقصود.</p>
<h2>آلية الاعتراض</h2>
<p>أي مطور يرى أن بياناته المنشورة أقوى مما ظهر في الجدول يراسلنا عبر <a href="/contact/">صفحة التواصل</a> بروابط البيانات، وتُراجع وتُحدَّث الدرجة في المراجعة التالية مع توثيق التغيير في <a href="/corrections/">سجل التصحيحات</a>. المعايير موحدة على كل المطورين وتُطبَّق عليهم جميعًا بالطريقة نفسها، وتُنشر درجات كل شركة مع ما استندت إليه.</p>`,
  },
  {
    slug: "/disclosure/", crumb: "الإفصاح والشفافية", tag: "الشفافية",
    title: "الإفصاح والشفافية | دليل العبور",
    description: "سياسة الإفصاح في دليل العبور: قواعد الإدراج والترتيب، الاستقلال التحريري، وكيف يُدار أي تضارب مصالح.",
    h1: "الإفصاح والشفافية",
    body: `<h2>هل تُباع الإدراجات أو الترتيب في الدليل؟</h2>
<p>لا. الدليل لا يبيع إدراجًا ولا ترتيبًا ولا تغطية، ولا يقبل مقابلًا ماديًا مقابل موضع في أي صفحة أو رابط داخل المحتوى التحريري — وهذا ينطبق على كل الكيانات المُدرجة، بما فيها <a href="/developers/">شركات التطوير العقاري</a> ومشروعاتها ومدارسها وخدماتها.</p>
<h2>كيف تُبنى الدرجات والأوصاف؟</h2>
<p>كل درجة أو وصف في الدليل مبني على ما تنشره الجهة المعنية من مصادر قابلة للفحص، وبمعايير واحدة تُطبق على الجميع دون استثناء. كل الروابط الخارجية لمواقع المطورين تحمل السمة نفسها (nofollow) دون استثناء.</p>
<h2>كيف يُدار تضارب المصالح؟</h2>
<p>أي علاقة تجارية أو تعاون يخص كيانًا مُدرجًا تُدار بالمعايير الموحدة نفسها، ويُفصح عنها في الصفحة المعنية عند اللزوم، ويُوثق أي تغيير في <a href="/corrections/">سجل التصحيحات</a>.</p>
<h2>التزامنا</h2>
<p>أي قارئ يرى أن محتوى بعينه يوحي بعلاقة غير مصرح بها أو يفضّل جهة دون أخرى يمكنه الاعتراض عبر <a href="/contact/">صفحة التواصل</a>، وسنراجع الاعتراض وننشر التصحيح الموثق.</p>`,
  },
  {
...
<p>المواقع الرسمية للمطورين الأربعة والعشرين المقيَّمين، وتصريحاتهم الصحفية الموقعة، ومخططات المشروعات المعلنة؛ ما تنشره المنصات الوسيطة يُذكر كسياق ولا يرفع الدرجة. تفاصيل المعايير في <a href="/methodology/">صفحة المنهجية</a>.</p>`,
  },
  {
