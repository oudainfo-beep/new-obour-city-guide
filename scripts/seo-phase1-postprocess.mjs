...
<p>يلتزم الدليل بمعايير تحقق موحدة تُطبق على الجميع دون استثناء. لا توجد علاقة ملكية أو تمويل أو إدارة أو شراكة تجارية بين دليل العبور وأي من الشركات أو الأنشطة المُدرجة — بما فيها شركات التطوير العقاري في <a href="/developers/">دليل المطورين</a>. الدرجات والأوصاف مبنية فقط على ما تنشره كل جهة وتقدمه من مصادر قابلة للفحص.</p>
<h2>ماذا لا نفعل؟</h2>
...
<h2>الاستقلالية</h2>
<p>لا يقبل الدليل محتوى إعلانيًا مموّهًا، ولا روابط مدفوعة داخل المحتوى التحريري، ولا يُمنح أي مطوّر أو نشاط ترتيب أو تغطية مفضلة مقابل مقابل. لا توجد علاقة ملكية أو تمويل أو شراكة تجارية تربط الدليل بأي من الكيانات المُدرجة. أي علاقة مستقبلية قد تُعد تضارب مصالح يجب أن تُفصح عنها الصفحة المعنية وتُدار بمعايير موحدة على الجميع.</p>
<h2>الأخطاء</h2>
...
<h2>آلية الاعتراض</h2>
<p>أي مطور يرى أن بياناته المنشورة أقوى مما ظهر في الجدول يراسلنا عبر <a href="/contact/">صفحة التواصل</a> بروابط البيانات، وتُراجع وتُحدَّث الدرجة في المراجعة التالية مع توثيق التغيير في <a href="/corrections/">سجل التصحيحات</a>. المعايير موحدة على كل المطورين، ولا توجد علاقة تضارب مصالح بين الدليل وأي شركة مُقيَّمة.</p>`,
  },
  {
    slug: "/disclosure/", crumb: "الإفصاح والشفافية", tag: "الشفافية",
    title: "الإفصاح والشفافية | دليل العبور",
    description: "سياسة الإفصاح في دليل العبور: استقلالية التحرير، عدم وجود علاقة تجارية بالكيانات المُدرجة، وكيف نتعامل مع أي تضارب مصالح مستقبلي.",
    h1: "الإفصاح والشفافية",
    body: `<h2>هل دليل العبور تابع لأي شركة أو مطوّر؟</h2>
<p>لا. دليل العبور والعبور الجديدة دليل معلوماتي مستقل. لا توجد أي علاقة ملكية أو تمويل أو إدارة أو شراكة تجارية أو endorsement بين الدليل وبين أي من الشركات أو الأنشطة المُدرجة — بما فيها <a href="/developers/">شركات التطوير العقاري</a> ومشروعاتها ومدارسها وخدماتها.</p>
<h2>كيف نضمن الاستقلالية عمليًا؟</h2>
<p>كل درجة أو وصف في الدليل مبني على ما تنشره الجهة المعنية من مصادر قابلة للفحص. لا نمنح أي جهة ترتيبًا مفضًا، ولا نبيع إدراجًا، ولا نقبل مقابلًا ماديًا مقابل موضع في أي صفحة. كل الروابط الخارجية لمواقع المطورين تحمل السمة نفسها (nofollow) دون استثناء.</p>
<h2>ماذا لو ظهر تضارب مصالح لاحقًا؟</h2>
<p>إذا أُبرم أي تعاون أو علاقة تجارية مستقبلية بين الدليل وأي كيان مُدرج، سُفصح عنها علنًا في الصفحة المعنية وسيُوثق التغيير في <a href="/corrections/">سجل التصحيحات</a>. إلى ذلك الحين، يبقى الدليل محايدًا تجاه الجميع.</p>
<h2>التزامنا</h2>
<p>أي قارئ يرى أن محتوى بعينه يوحي بعلاقة غير مصرح بها أو يفضّح جهة دون أخرى يمكنه الاعتراض عبر <a href="/contact/">صفحة التواصل</a>، وسنراجع الاعتراض وننشر التصحيح الموثق.</p>`,
  },
  {
