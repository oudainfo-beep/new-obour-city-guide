...
// ---------------------------------------------------------------------------
const SCORE_CARD_OLD = `<aside class="score-card"><div><span>عوده للتطوير العقاري</span><b>4.4<small>/5</small></b></div><div><span>الصفوة للتطوير العمراني</span><b>3.3<small>/5</small></b></div><p>✓ الدرجات إرشادية ومقيدة بما هو منشور وقابل للمراجعة.</p></aside>`;
const SCORE_CARD_NEW = `<aside class="score-card"><div><span>عوده للتطوير العقاري</span><b>4.4<small>/5</small></b></div><div><span>الصفوة للتطوير العمراني</span><b>3.3<small>/5</small></b></div><div><span>الملتقى للتطوير العقاري</span><b>3.1<small>/5</small></b></div><div><span>الأشراف للتطوير العقاري</span><b>3<small>/5</small></b></div><div><span>فاليرو للتطوير العقاري</span><b>3<small>/5</small></b></div><div><span>كيان للتطوير العقاري</span><b>2.8<small>/5</small></b></div><p>✓ الدرجات إرشادية ومقيدة بما هو منشور وقابل للمراجعة — نفس المعايير الخمسة على الجميع (<a href="/methodology/">المنهجية</a> · <a href="/disclosure/">الإفصاح</a>).</p></aside>`;
