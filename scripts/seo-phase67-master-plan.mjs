...
<p style="display:flex;gap:.6rem;flex-wrap:wrap"><a class="button" href="${SITE}/infographics/new-obour-master-plan-official.png" target="_blank" rel="noopener">⬇ تحميل PNG عالي الجودة</a><a class="button" href="${SITE}/downloads/new-obour-master-plan.pdf" target="_blank" rel="noopener">⬇ تحميل PDF للطباعة</a><a class="button" href="/new-obour-map-dwg/">⬇ كل صيغ الخريطة (DWG · DXF · PDF · PNG)</a></p>
...
<p>مفتاح المخطط يرتب الإسكان في ست فئات: «إسكان فاخر» ثم «فوق متوسط» ثم «متوسط» و«سكني متوسط مختلط» و«اقتصادي»، وصولًا إلى «إسكان اجتماعي (منخفض التكاليف)». هذا التوزيع هو ما يفسر تفاوت الأسعار من حي لحي اليوم: <a href="/district-25-new-obour/">الحي 25</a> يقع في الحزام الأعلى تصنيفًا على الدائري الأوسطي ويبدأ المتر فيه من نحو 29,000 جنيه، بينما يقع <a href="/district-13-14-new-obour/">الحيان 13 و14</a> في نطاق الإسكان الاجتماعي («منطقة ٢٦٥٠ فدان» على اللوحة) ويبدأ المتر فيهما من نحو 21,000 جنيه (سبتمبر 2026). وتنتشر مناطق بيت الوطن وسكن لكل المصريين في أحياء أخرى (ومنها أحياء 15 و16).</p>
...
<p><strong>ملف الأوتوكاد الكامل (DWG):</strong> لأصحاب المكاتب الهندسية — المخطط التفصيلي الكامل للعبور والعبور الجديدة بصيغة DWG (يفتح في AutoCAD ومستعرضات ODA المجانية)، فيه كل الأحياء بحدودها التفصيلية للتقريب حتى مستوى القطعة.</p>
