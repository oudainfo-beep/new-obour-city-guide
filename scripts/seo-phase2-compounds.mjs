...
const COMPOUNDS = [
  ...
  },
  {
    ...
    district: { slug: null, name: "العبور ومجتمعاته" },
    status: "مشروع معلن",
    source: "موقع إبداع للتطوير العقاري الرسمي المنشور",
    published: [
      "مشروع معلن في العبور ومجتمعاته.",
      "المطور مدرج في صفحة 'قيد الاستكمال' بدليل المطورين لقلة البيانات المنشورة الكافية للمقارنة.",
    ],
  },
];
...
function compoundPage(chrome, c) {
  ...
  const title = `${c.name} في العبور الجديدة: البيانات المنشورة | دليل العبور`;
  const description = `صفحة ${c.name} في العبور الجديدة: ما نشره المطور، ما هو ناقص، وكيف تتحقق بنفسك قبل أي قرار.`;
