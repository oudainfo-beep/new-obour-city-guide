...
const COMPARE_ROWS = [
  ["الفئة على المخطط الاستراتيجي", "«إسكان اجتماعي (منخفض التكاليف)»", "الحزام الأعلى تصنيفًا: «فوق متوسط» ملاصق لـ«فاخر»"],
...
const FAQ = [
  ...
  { q: "إيه الفرق بين الحي 14 والحي 25؟",
    a: "الحي 14 في نطاق «إسكان اجتماعي (منخفض التكاليف)» بكثافة عالية ونماذج 75 و90 م²، ويبدأ المتر فيه من نحو 21,000 جنيه. أما الحي 25 ففي الحزام السكني الأعلى تصنيفًا («فاخر» و«فوق متوسط») بكمبوندات منخفضة الكثافة، ويبدأ المتر فيه من نحو 29,000 جنيه." },
