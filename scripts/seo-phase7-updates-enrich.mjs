...
const FAQ = [
  ...
  { q: "هل يمكنني متابعة التحديثات بدون زيارة الموقع؟", a: "نعم. اشترك عبر ملف <a href='/feed.xml'>feed.xml</a> باستخدام أي قارئ RSS. يُحدَّث تلقائيًا مع كل تحديث جديد للدليل." },
  { q: "لماذا الصفحة فارغة أحيانًا؟", a: "الصفحة تعرض فقط التحديثات المُوثّقة بمصادرها. إذا لم تتوفر تحديثات موثّقة، نفضّل ترك الصفحة فارغة بدل نشر معلومات غير مؤكدة." },
];
