...
const CLUSTERS = {
  housing: ["dar-misr-obour", "sakan-misr-obour", "villas-for-sale-obour", "installments-obour", "choose-apartment", "golf-city-obour", "quest-obour", "new-obour-real-estate", "new-obour-lands", "new-obour-utilities", "new-obour-transport", "new-obour-shopping-daily", "obour-history", "price-forecast-obour", "commercial-real-estate", "mortgage-finance-obour", "studio-sale-obour", "duplex-obour", "ground-floor-garden-obour", "offplan-obour", "resale-obour", "rental-yield-obour", "rent-to-own-obour", "social-housing-obour"],
