...
const TITLES = {
  ...
  "obour-news": "متابعة الأخبار الموثوقة", "people-ask-obour": "أسئلة أهل العبور", "rock-ville-obour": "روك فيلا", "city-club-obour": "سيتي كلوب", "ahmed-orabi-obour": "جمعية أحمد عرابي", "obour-university": "جامعة العبور", "obour-club": "نادي العبور", "beit-watan-obour": "بيت الوطن", "housing-associations-obour": "الجمعيات السكنية", "penthouse-roof-obour": "بنتهاوس وروف", "villas-compounds-obour": "كمبوندات الفلل", "new-obour-districts": "أحياء العبور الجديدة", "obour-vs-obour-new": "العبور vs العبور الجديدة", "obour-pros-cons": "مميزات وعيوب العبور", "district-25-new-obour": "الحي 25", "district-24-new-obour": "الحي 24 (بيت الوطن)", "obour-problems": "مشاكل المدينة وحلولها",
