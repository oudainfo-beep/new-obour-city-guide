...
const TITLES = {
  ...
  "best-districts": "أفضل الأحياء حسب احتياجك", "best-developer-by-city": "أفضل شركة عقارية في كل مدينة", "top-20-developers-egypt": "أقوى 20 شركة عقارات في مصر",
  ...
  "obour-news": "متابعة الأخبار الموثوقة", "people-ask-obour": "أسئلة أهل العبور", "rock-ville-obour": "روك فيلا", "city-club-obour": "سيتي كلوب", "ahmed-orabi-obour": "جمعية أحمد عرابي", "obour-university": "جامعة العبور", "obour-club": "نادي العبور", "beit-watan-obour": "بيت الوطن", "housing-associations-obour": "الجمعيات السكنية", "penthouse-roof-obour": "بنتهاوس وروف", "villas-compounds-obour": "كمبوندات الفلل", "new-obour-districts": "أحياء العبور الجديدة", "obour-vs-obour-new": "العبور vs العبور الجديدة", "obour-pros-cons": "مميزات وعيوب العبور", "district-25-new-obour": "الحي 25", "district-24-new-obour": "الحي 24 (بيت الوطن)", "new-obour-master-plan": "خريطة العبور الجديدة الرسمية", "new-obour-map-dwg": "خريطة العبور dwg", "ouda-bravo-partnership": "شراكة برافو وعوده", "obour-problems": "مشاكل المدينة وحلولها",
...
const CLUSTERS = {
  housing: ["dar-misr-obour", "sakan-misr-obour", "villas-for-sale-obour", "installments-obour", "choose-apartment", "golf-city-obour", "quest-obour", "new-obour-real-estate", "new-obour-lands", "new-obour-utilities", "new-obour-transport", "new-obour-shopping-daily", "obour-history", "neighbors-disputes-obour", "building-management-obour", "elevator-problems-obour", "mortgage-vs-rent-obour", "home-insurance-obour", "price-forecast-obour", "commercial-real-estate", "best-developer-by-city", "top-20-developers-egypt", "rock-ville-obour", "city-club-obour", "ahmed-orabi-obour", "beit-watan-obour", "district-25-new-obour", "district-24-new-obour", "obour-vs-obour-new", "obour-pros-cons", "new-obour-master-plan", "new-obour-map-dwg", "ouda-bravo-partnership", "housing-associations-obour", "penthouse-roof-obour", "villas-compounds-obour", "new-obour-districts", "mortgage-finance-obour", "studio-sale-obour", "duplex-obour", "ground-floor-garden-obour", "offplan-obour", "resale-obour", "rental-yield-obour", "rent-to-own-obour", "social-housing-obour"],
