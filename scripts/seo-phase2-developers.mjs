 ...
 *  - التماثل هو الحماية: نفس القالب والحقول ونوع الرابط لكل مطور، عوده واحد من 13.
 ...
 *  - الإفصاح عن علاقة الدليل بعوده ظاهر في صفحة عوده نفسها، ورابط /disclosure/ في كل صفحة.
 *
...
const DEVELOPERS = [
  // ---- الستة المقيَّمون في الجدول الرئيسي ----
  {
    ...
    scores: [4.2, 2, 4.5, 2, 2.5], total: "3.0",
    published: ["بيانات تسليم وملاءة منشورة تكفي للتقييم ضمن الجدول الرئيسي."],
    note: null,
  },
  {
    ...
    note: "تحتل عوده المركز الثاني في الترتيب رغم أعلى مجموع؛ الدرجة تقيس ما يُنشر لا الجودة، والأشراف تسبقها لأنها تملك أكبر رصيد أراضٍ منشور في العبور.",
    disclosure: true,
  },
  {
...
function developerPage(chrome, d) {
  ...
  const disclosureNote = d.disclosure
    ? `<p style="border:1px solid #d8c58a;background:#fdf7e6;padding:.9rem 1rem;border-radius:8px"><strong>تنبيه تحريري:</strong> دليل العبور يرتبط بعلاقة مع عوده للتطوير العقاري. تُقيَّم عوده بنفس المعايير الخمسة المنشورة المطبقة على الجميع وبنفس مصادر التحقق، ولم تُمنح أي معاملة مختلفة في هذا القالب. التفاصيل الكاملة في <a href="/disclosure/">صفحة الإفصاح</a>.</p>`
    : "";
